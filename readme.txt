# Track Changes
Contributors:      cwhitmore
Tags:              git, block-theme, developer, helper, utility, create block theme
...
Effortlessly identify Site Editor customizations for Git-based workflows.
...
* [View on GitHub](https://github.com/unscripted/wp-track-changes)
...
While the Track Changes plugin is a developer tool, it is intended for use in production environments.

1. You have a couple of options:
	- Go to Plugins &rarr; Add New and search for "Track Changes". Once found, click "Install".
	- Download Track Changes from wordpress.org and make sure the folder is zipped. Then upload via Plugins &rarr; Add New &rarr; Upload.
